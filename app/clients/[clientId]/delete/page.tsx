...
const ClientDeletePage = ({ params }: ClientAssuUpdatePageProps) => {
    ...
    <div className="w-full mx-auto ">
      ...
      <div className="flex justify-center">
        <form
          ...
          className="border border-hov rounded-lg p-2 mt-5 w-1/2  max-md:w-full bg-red"
        >
          <div className="bg-black-400 text-center text-red-400 text-xl py-2">
            {"Etes-vous sûr de vouloir supprimer un client ?"}
          </div>
